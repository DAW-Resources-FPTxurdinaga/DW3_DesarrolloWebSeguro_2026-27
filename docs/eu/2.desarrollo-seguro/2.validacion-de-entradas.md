...
Itxuraz, dena ondo funtzionatu duela dirudi.
...
```text
           ...
           Ikasle berriaren alta

┌────────────────────────────────────────────┐
│ Izena:               ____________________  │
│ Abizenak:            ____________________  │
│ NANa:                ____________________  │
│ Helbide elektronikoa: ____________________  │
│ Jaiotze-data:        ____________________  │
│                                            │
│               [ Gorde ]                   │
└────────────────────────────────────────────┘
```
...
Adibidez, **TxurdiGest**-en ez da nahikoa helbide elektroniko batek formatu zuzena izatea. Horrez gain, egiaztatu behar da helbide berarekin aurretik beste erabiltzaile bat erregistratuta ez dagoela.
...
![Kanpotik jasotako datu guztiek balidazio-geruza batetik igaro behar dute prozesatu aurretik.](../../assets/bloque2/validacion-puntos-de-entrada.png){ align=center }

*2.1 irudia. Kanpotik datozen datu guztiak potentzialki ez-fidagarritzat jo behar dira, eta aplikazioak prozesatu baino lehen baliozkotu.*
