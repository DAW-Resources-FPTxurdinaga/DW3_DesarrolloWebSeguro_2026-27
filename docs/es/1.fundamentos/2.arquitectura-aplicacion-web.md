...
En este capítulo se analizará la arquitectura básica de una aplicación web, el recorrido que realiza una petición desde el navegador hasta la base de datos y la función que desempeña cada uno de los elementos implicados.
...
Muchos frameworks modernos, como Laravel o Spring Boot, siguen este principio de organización, aunque utilicen estructuras internas más complejas.
...
Una aplicación web no es únicamente código. Es un conjunto de componentes que colaboran entre sí para ofrecer un servicio.

Comprender cómo se relacionan esos componentes es el primer paso para identificar dónde pueden aparecer riesgos y cómo reducirlos durante el desarrollo.
...
**Página anterior:** [Introducción al desarrollo web seguro](1.introduccion-desarrollo-web-seguro.md)

**Página siguiente:** [Protocolo HTTP](3.protocolo-http.md)