...
![Separación entre código fuente y configuración segura mediante variables de entorno.](../../assets/bloque2/codigo-configuracion-secretos.png){ width="850" align="center" }

*Figura 2.5. Las aplicaciones seguras mantienen los secretos fuera del código fuente utilizando mecanismos de configuración independientes.*
...
El desarrollador debe mantener separados el código y la configuración, proteger los secretos de la aplicación y aplicar una gestión segura de las sesiones. Estas decisiones forman parte del desarrollo y facilitan tanto la seguridad como el despliegue en distintos entornos.
