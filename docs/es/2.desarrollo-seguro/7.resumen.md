...
Después de este bloque, la forma de desarrollar aplicaciones debe cambiar.

El objetivo ya no es únicamente conseguir que una funcionalidad funcione correctamente.

El desarrollador debe preguntarse también:
